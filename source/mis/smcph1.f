...
9901  FORMAT(' SYMMETRIC DECOMPOSITION FOUND NO TERMS BEING '
     &,' CONNECTED TO DIAGONAL ON COLUMN ',I8)
2005  CONTINUE
...
9001  FORMAT(1X,A23,/,' INSUFFICIENT MEMORY TO DECOMPOSE MATRIX IN '
     &,I4,' FILE NAME=',2A4
     &,/,' NUMBER OF COLUMNS=',I8,' TYPE=',I2,' MEMORY AVAILABLE =',I16
     &,/,' MINIMUM REQUIRED IS =',I16)
C      CALL MESAGE ( -8, 0, 0 )
      IERROR = 1
      GO TO 7777
...
9004  FORMAT(/
     ...
     &,/, 7X,' COLUMNS CONTAINED IN MEMORY                         =',I16
     &,/, 7X,' COLUMNS WRITTEN TO SPILL FILE                       =',I16
     &,/, 7X,' MAX. NO. OF ACTIVE ROWS FOR ANY ACTIVE COLUMN       =',I16
     &,/, 7X,' MAX. NUMBER OF COLUMNS REFERENCED BY A PIVOT COLUMN =',I16   
     &,/, 7X,' MAX. TERMS FOR ANY GIVEN INNER LOOP                 =',I16
     &,/, 7X,' TOTAL WORDS IN OPEN CORE USED FOR COLUMN DATA       =',I16 
     & )
