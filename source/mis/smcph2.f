...
8002  FORMAT(
     &    7X,' ESTIMATED OPEN CORE NEEDED TO ELIMINATE USE OF SPILL=',I16
     &,/, 7X,' OPEN CORE AVAILABLE FOR THIS DECOMPOSITION          =',I16 
     & )
C
...
9008  FORMAT(8X,'INSUFFICIENT OPEN CORE FOR DECOMPOSITION WITH NEW'
     &,' METHOD'
     &,/,    8X,'TOTAL NUMBER OF COLUMNS IN MATRIX =',I16
